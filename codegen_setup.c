...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "MediEvil II",
    .project_root_env = "MEDIEVIL_II_RECOMP_PROJECT_ROOT",
    .build_dir_env = "MEDIEVIL_II_RECOMP_BUILD_DIR",
    .force_setup_env = "MEDIEVIL_II_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_945.64_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "MediEvil_II__Recompiled",
    .prepare_note =
